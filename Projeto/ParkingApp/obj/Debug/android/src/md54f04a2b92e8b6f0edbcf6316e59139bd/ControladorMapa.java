...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ParkingApp.ControladorMapa, ParkingApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ControladorMapa.class, __md_methods);
	}


	public ControladorMapa () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ControladorMapa.class)
			mono.android.TypeManager.Activate ("ParkingApp.ControladorMapa, ParkingApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public ControladorMapa (android.app.Activity p0, com.google.android.gms.maps.GoogleMap p1) throws java.lang.Throwable
	{
		super ();
		if (getClass () == ControladorMapa.class)
			mono.android.TypeManager.Activate ("ParkingApp.ControladorMapa, ParkingApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.App.Activity, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Gms.Maps.GoogleMap, Xamarin.GooglePlayServices.Maps, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0, p1 });
	}
